    ...
    <main className="radar-shell flex min-h-screen items-center justify-center bg-black px-5 py-12 text-white">
      <section className="brand-panel w-full max-w-md p-6 sm:p-8">
        ...
        <p className="mt-4 font-semibold leading-7 text-white/60">
          Access saved opportunities, admin tools and Deal Radar launch resources.
        </p>
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          <input
            ...
            className="brand-field w-full px-5 py-4 text-white outline-none transition focus:border-[#f45a1d]"
          />
          ...
          <button
            type="submit"
            disabled={loading}
            className="brand-button flex w-full items-center justify-center px-5 py-4 font-black disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <p className="mt-6 text-center text-sm text-white/50">
          ...
          <Link href="/signup" className="font-black text-[#ffb199]">
            Create one
          </Link>
        </p>
      </section>
